...
v1.2.0-213 是给 2021.3 版本的idea用的，根据提示，你的版本应该是 2022.1，我构建了个 2022.1 的版本，你可以下载试试。
👉[Simple-Deploy-1.2.0-221.zip](https://github.com/lin2j/simple-deploy/releases/download/v1.2.0-213/Simple-Deploy-1.2.0-221.zip)